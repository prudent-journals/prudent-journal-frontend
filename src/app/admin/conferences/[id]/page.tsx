...
import { ArrowLeft, Users, Upload, FileText, MapPin, Calendar, Library } from 'lucide-react';
  ...
  return (
    <div className="p-6 lg:p-10 max-w-5xl">
      ...
      <section className="card p-6 mb-6">
        <h2 className="font-serif text-lg text-navy-900 mb-1">Proceedings</h2>
        <p className="font-sans text-sm text-navy-500 mb-4">
          To publish a titled book of proceedings for this conference, with its own public page,
          reader and downloads, use{' '}
          <Link href="/admin/proceedings" className="text-gold-700 underline inline-flex items-center gap-1">
            <Library className="w-3.5 h-3.5" /> Book of Proceedings
          </Link>{' '}
          in the main menu.
        </p>
